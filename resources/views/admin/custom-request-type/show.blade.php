                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><mark class="text-primary">{{ __('field_requires_document') }}:</mark> 
                                    @if( $row->requires_document == 1 )
                                    <span class="badge badge-pill badge-success">{{ __('status_yes') }}</span>
                                    @else
                                    <span class="badge badge-pill badge-secondary">{{ __('status_no') }}</span>
                                    @endif
                                </p><hr/>
