                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control transition_type" name="type" id="type" required>
                                <option value="">{{ __('select') }}</option>
                                <option value="1" @if($row->type == 1) selected @endif>{{ __('field_program_change') }}</option>
                                <option value="2" @if($row->type == 2) selected @endif>{{ __('field_work_shift_change') }}</option>
                            </select>
                        ...
                        <div class="form-group col-md-4 program_fields" @if($row->type != 1) style="display: none;" @endif>
                            ...
                            <select class="form-control" name="current_program" id="current_program">
                                ...
                                <option value="{{ $program->id }}" @if($row->current_program_id == $program->id) selected @endif>{{ $program->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4 program_fields" @if($row->type != 1) style="display: none;" @endif>
                            ...
                            <select class="form-control" name="new_program" id="new_program">
                                <option value="">{{ __('select') }}</option>
                                @foreach( $programs as $program )
                                <option value="{{ $program->id }}" @if($row->new_program_id == $program->id) selected @endif>{{ $program->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4 work_shift_fields" @if($row->type != 2) style="display: none;" @endif>
                            ...
                            <select class="form-control" name="current_work_shift" id="current_work_shift">
                                ...
                                <option value="{{ $workShift->id }}" @if($row->current_work_shift_id == $workShift->id) selected @endif>{{ $workShift->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4 work_shift_fields" @if($row->type != 2) style="display: none;" @endif>
                            ...
                            <select class="form-control" name="new_work_shift" id="new_work_shift">
                                <option value="">{{ __('select') }}</option>
                                @foreach( $workShifts as $workShift )
                                <option value="{{ $workShift->id }}" @if($row->new_work_shift_id == $workShift->id) selected @endif>{{ $workShift->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="reason" id="reason" rows="3" required>{{ $row->reason }}</textarea>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="note" id="note" rows="3">{{ $row->note }}</textarea>
                        </div>
                        <!-- Form End -->
                      </div>
                    </div>
